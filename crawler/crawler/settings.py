...
SECRET_KEY = os.environ.get('SECRET_KEY', 'django-insecure-default-key-change-me-in-prod')
...
DATABASES = {
    'default': {
        ...
        'NAME': os.environ.get('DB_NAME', 'crawler_db'),
...
LOGOUT_REDIRECT_URL = 'scanner:login'
